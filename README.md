...
|---|---|---|
| **macOS** | [Esfinge-2.7.0.dmg](https://github.com/webcafeina/esfinge/releases/download/v2.7.0/Esfinge-2.7.0.dmg) | Universal: Apple Silicon e Intel |
| **Windows** | [Esfinge-2.7.0-windows-instalador.exe](https://github.com/webcafeina/esfinge/releases/download/v2.7.0/Esfinge-2.7.0-windows-instalador.exe) | Asistente de instalación |
| **Linux · Debian y Ubuntu** | [esfinge_2.7.0_amd64.deb](https://github.com/webcafeina/esfinge/releases/download/v2.7.0/esfinge_2.7.0_amd64.deb) | Aplicación y línea de comandos |
| **Linux · cualquiera** | [esfinge-2.7.0-linux-amd64.tar.gz](https://github.com/webcafeina/esfinge/releases/download/v2.7.0/esfinge-2.7.0-linux-amd64.tar.gz) | Los binarios sueltos |
| **Línea de comandos** | [todos los sistemas](https://github.com/webcafeina/esfinge/releases/latest) | Seis objetivos, con sus SHA256 |

Versión **2.7.0**. Las anteriores, en [publicaciones](https://github.com/webcafeina/esfinge/releases).
