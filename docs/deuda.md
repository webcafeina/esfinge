...
| La bóveda con datos de verdad | Media | **Parcialmente comprobado (2026-09-09)**: en un Mac, con una exportación real de Dashlane, que se importa y a primera vista está bien. Falta contrastar el número de entradas contra el gestor de origen, **abrir la bóveda con la clave de recuperación apuntada** —lo único que demuestra que lo apuntado vale— y vivir con ella lo bastante para saber si los plazos estorban. De eso depende seguir o parar ([ADR 0023](adr/0023-la-boveda.md)). Bajó de Alta a Media al pasar el primer CSV de verdad | Abierto · depende del humano |
