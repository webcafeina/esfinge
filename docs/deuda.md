...
| Guardar y actualizar desde la página en sitios de verdad | **Alta** | **Probada por el cliente con la 2.21.0 hasta cambiar la contraseña** (2026-09-14): en Google, con la página del usuario y la de la contraseña separadas, **rellenaba y ofrecía actualizar la cuenta de otro usuario**; corregido en la 2.21.1 recordando el usuario de la página anterior ([ADR 0032](adr/0032-guardar-desde-la-pagina.md)). Escrito y probado aquí por piezas —qué es cada formulario, cuándo caduca un pendiente, la tarjeta, y en Go la tubería entera— pero **nadie ha enviado un formulario de verdad con la extensión cargada**. Hay que ver en el Mac, en Firefox y en Chrome: entrar con una cuenta nueva, entrar con otra contraseña, registrarse, cambiar la contraseña, un inicio fallido, «Nunca en este sitio» y deshacerlo, y que la ventana se ponga al día sola ([ADR 0032](adr/0032-guardar-desde-la-pagina.md)) | Abierto · depende del humano |
...
| «La contraseña era mala» es una heurística | Media | Tras enviar, **si vuelve a salir un campo de contraseña se da por fallido** y no se ofrece. Falla en los dos sentidos: un sitio que tras entrar enseña otro formulario con contraseña no ofrecerá nada, y uno que dice «contraseña incorrecta» sin volver a pintar el campo ofrecería guardar la mala. El segundo es el caro, y por eso, al registrarse o cambiar, solo cuenta si el campo sigue relleno. Se afina **con los casos que salgan**, no a ciegas. **Y un tercero, sin comprobar**: un sitio que cambia la contraseña sin cambiar de página y **deja los campos rellenos** tras un cambio bien hecho no ofrecerá nada; puede ser Brevo, cuya página después de guardar no se ha podido ver (2.21.2) | Abierto · se ve con el uso |
