...
|---|---|---|---|
| No se sincroniza al volver a la ventana | Baja | El plan (`docs/cuentas.md`) decía que al volver el foco a la ventana se pediría una pasada, como mucho una cada 30 s. **No se hizo en la A2**: el otro equipo se entera al abrir la bóveda, cada cinco minutos, al guardar algo o con «Sincronizar ahora». Se le dijo al cliente | Abierto · la A3 |
