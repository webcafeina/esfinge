...
| La política de privacidad de la cuenta sin revisión legal | Media | Desde la A2 dice qué se guarda, dónde, quién más interviene —Cloudflare y Resend, empresas de EE. UU. con los datos de las cuentas guardados en la UE— y qué se puede pedir. Está escrita con los hechos del código, **no la ha revisado un abogado**, y faltan las condiciones de uso. Con el registro por invitación el riesgo es pequeño; **antes de abrirlo es obligatorio** ([ADR 0035](adr/0035-las-cuentas.md)) | Abierto · antes de la A4 |
