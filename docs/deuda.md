...
| El servidor puede congelar o bifurcar la versión de la bóveda | Baja | La versión es un número y no una cadena que ate cada documento al anterior: un servidor malicioso puede dejar a un equipo en la versión que ya tiene, o servirle a cada uno su propia rama, sin que ninguno se entere. **No puede inventarse contenido.** Se cerraría sellando la huella del documento anterior, que es una subida de formato. Dicho en `docs/seguridad.md` (revisión del 2026-09-23) | Abierto · antes de la auditoría no hace falta |
