...
| ~~El canal del navegador, comprobado solo en Firefox~~ | Baja | **Comprobado en las dos familias** (2026-09-10): Firefox en la 2.17.6 y Chrome en la 2.17.7, las dos de punta a punta en un Mac. Lo que queda es que **el identificador de la tienda será otro** cuando se suba: se añade al lado de éste y ya | Saldada · queda el de la tienda, en la entrega 5 |
