...
| El canal del navegador, comprobado solo en Firefox | Baja | De punta a punta en un Mac con Firefox (2.17.6). Chrome y los suyos deberían funcionar igual desde la 2.17.7 —el identificador está fijado con una `key` en el manifiesto— pero **nadie lo ha visto correr**. Y el de la tienda seguirá siendo otro hasta que se suba | Abierto · depende del humano |
