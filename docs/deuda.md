...
| **El icono con estados y la marca en el campo, en el Mac** | Media | Medido y probado aquí, pero la barra de verdad **no se puede capturar**: las capturas son una composición. Falta ver si la silueta se lee en la barra, si la insignia cambia sola al cambiar de pestaña, si **el candado aparece como mucho un minuto después** de cerrarse la bóveda, y el filete y el aviso sobre los estilos de Brevo y Cloudflare. Y si **el correo cabe entero** en el panel con San Francisco, que el cliente dejó para esta versión ([ADR 0031](adr/0031-el-icono-con-estados-y-la-marca-en-el-campo.md)) | Abierto · depende del humano, en la 2.20.0 |
