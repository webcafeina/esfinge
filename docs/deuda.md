...
| **Rellenar el código en formularios de verdad** | Media | **La 2.19.0 no lo rellenaba en Cloudflare** —la detección no reconocía sus casillas— y lo vio el cliente a la primera. Arreglado en la 2.19.1 con su formulario copiado de la consola a las pruebas, y **la escritura comprobada contra su mismo componente** (`OTPField` de Base UI, en React). Falta verlo en su página de verdad, y en otros formularios: los que solo reaccionan a pegar o a teclas no se rellenarán, aunque ahora Esfinge **lo dice** en vez de contar que ha ido bien ([ADR 0030](adr/0030-rellenar-el-codigo-de-un-solo-uso.md)) | Abierto · depende del humano, en la 2.19.1 |
