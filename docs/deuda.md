...
| El canal del navegador solo en Firefox | Media | Comprobado de punta a punta en un Mac con Firefox (2.17.6). **Chrome no puede funcionar todavía**: su identificador lo asigna la tienda y hasta entonces el manifiesto que autoriza a lanzar el puente va vacío. Para probar antes, `ESFINGE_EXTENSIONES` | Abierto · fase 2, entrega 5 |
