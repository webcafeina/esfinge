...
| Exportar y borrar la cuenta entera, solo por correo | Baja | El servidor ya sabe hacer las dos cosas (`/v1/cuenta/exportacion`, `DELETE /v1/cuenta`), pero la ventana no tiene los botones: la política dice que se pidan en info@webcafeina.com mientras tanto | Abierto · la A3 |
