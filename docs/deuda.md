...
|---|---|---|---|
| La prueba «la clave de recuperación abre la bóveda» falla de vez en cuando | Media | Tras «Cerrar la bóveda», la interfaz vuelve a pedir la lista (`BuscarEnBoveda`) cuando ya está cerrada, el servidor de desarrollo contesta `400 La bóveda está cerrada` y la prueba, que vigila los errores de la consola, falla. **Ya pasaba antes de la A1**: medido el 2026-09-18 con el código de la 2.22.2, 1 de cada 12; con el de la A1, 3 de 12. Es una carrera de la interfaz, no de la bóveda, y puede estar dándose también en el Mac sin que se vea | Abierto · arreglar en la A2, que toca esa pantalla |
