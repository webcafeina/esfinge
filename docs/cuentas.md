...
| **B2** | Mandar y recibir entre cuentas: el sobre HPKE firmado, `llaves`, `envios` y `buzon` en el servidor, y el buzón que se acepta en la ventana y en el panel | e2e con dos cuentas, y los textos al día antes de publicar |
